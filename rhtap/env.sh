...
export IMAGE_URL=${IMAGE_URL-quay.io/tnevrlka-test/devfile-sample-nodejs-dance-test:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/tnevrlka-test/devfile-sample-nodejs-dance-test-gitops
